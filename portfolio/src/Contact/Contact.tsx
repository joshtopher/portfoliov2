export const Contact = () => {
  return (
    <section className='bg-secondary text-text-color px-1/10 py-10 z-10 flex justify-between flex-col lg:flex-row' id='contact'>
        <div className='w-1/2'>
          <h2 className='text-3xl font-bold'>Contact Me!</h2>
          <p className='text-2xl'>Feel free to reach out to me on any of the following platforms:</p>
        </div>
        <ul className='w-1/3 flex flex-col space-y-4 mt-10 lg:mt-0'>
